...
Participation.create(user: matteo, community_id: 2, role: :member)
Participation.create(user: marco, community_id: 2, role: :member)
Participation.create(user: giovanni, community_id: 2, role: :member)

Participation.create(user: matteo, community_id: 3, role: :member)

Participation.create(user: luca, community_id: 2, role: :member)

post = Post.create(user: luca, spotify_content: 'spotify:track:0ABEVL7pgQLokhBcNJmozw?si=f148e8af5af5425c',
                   community_id: 6, body: 'perfetta per la Balestra')
Comment.create(post: post, user: luca, body: 'Si fratello, perfetta per la Balestra')

post = Post.create(user: luca, spotify_content: 'spotify:track:0ABEVL7pgQLokhBcNJmozw?si=f148e8af5af5425c',
                   body: 'perfetta per la Balestra')
